...
class YOLOV2_FPHA_HPO_Bbox_2Hand_1(YOLOV2_FPHA_HPO_Bbox):
    """ YOLOv2 bounding box detection and hand regression from HPO method 
    with two hand regression from two separate conv output layers """
    ...
    def train_step(self, data_load):
        ...
        bbox_out, hand_left, hand_right     = self.net(img) 
    ...
    def valid_step(self, data_load):
        ...
        pred_bbox, hand_left, hand_right     = self.net(img) 
