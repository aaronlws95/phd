...
def evalaute_icvl_online():
    ...
    xyz_pred=numpy.empty((1596,400,21,3))
    for i in range(4):
        xyz_pred[:,i*100:(i+1)*100] = scipy.io.loadmat('%sdata/done_v1/icvl_M500_N1000_Rang10/pso_N99_M500_range10_seg%d.mat'%(base_dir,i))['jnt']*1000
    ...
    # numpy.save('%sdata/done/icvl_M500_N1000_Rang10/cost_pso_M500_N1000_range10.npy'%(base_dir),cost_matrix)
    cost_matrix=numpy.load('%sdata/done_v1/icvl_M500_N1000_Rang10/cost_pso_M500_N1000_range10.npy'%base_dir)
