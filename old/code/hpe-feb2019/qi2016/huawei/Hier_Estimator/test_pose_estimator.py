...
root_dir = '/home/aaron/data_delivered/'
...
def pose_estimator_pool(depth,models):
    p = Pool(8)
    scale=1.8
    setname='mega'
    bbsize=300
    ...
    data=([0,models,r0,palm_norm_uvd,scale],[1,models,r0,palm_norm_uvd,scale],[2,models,r0,palm_norm_uvd,scale],
          [3,models,r0,palm_norm_uvd,scale],[4,models,r0,palm_norm_uvd,scale])
    tmp = p.map(finger_estimator, data)
...
def main():
    ...
    # for i in numpy.random.randint(0,new_file_names.shape[0],100):
        ...
        # start=time.clock()
        xyz_pred,uvd_pred = pose_estimator(depth,models)
        print(xyz_pred)
        print(uvd_pred)
