...
def mid_derot_err_uvd_xyz(dataset,setname,dataset_path_prefix,source_name,source_name_ori,pred_save_name,jnt_idx,patch_size=24,offset_depth_range=0.8):
    ...
    direct =  '%sdata/%s/hier_derot_recur_v2/mid/best/'%(dataset_path_prefix,setname)
...
if __name__=='__main__':
    ...
    for i ,idx in enumerate(idx_all):
        err= mid_derot_err_uvd_xyz(dataset='train',
                              setname='icvl',
                              dataset_path_prefix=constants.Data_Path,
                                 ...
                                 source_name_ori='_icvl_r0_r1_r2_uvd_bbox_21jnts_20151113_depth200',
                                     pred_save_name='_offset_mid%d_patch40_beta6_24_48_1_1_adam_lm3'%idx,
                                     patch_size=40,
