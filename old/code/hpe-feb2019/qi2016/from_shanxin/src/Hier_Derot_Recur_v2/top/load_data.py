...
def load_data_multi_top_uvd_normalized(batch_size,path,pre_jnt_path,jnt_idx,is_shuffle,patch_size=24, patch_pad_width=4,offset_depth_range=0.8,hand_width=96,hand_pad_width=0):
