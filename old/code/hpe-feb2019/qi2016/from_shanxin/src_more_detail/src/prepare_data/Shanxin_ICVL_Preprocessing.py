...
def norm_hand(save_path, h5name, matname, dataset_dir, Metadatadir):
    ...
    for i in xrange(0,xyz_jnt_gt.shape[0],1):
        ...
        # plt.scatter(hand_jnt_gt_uvd[:,0]*img_size,hand_jnt_gt_uvd[:,1]*img_size)
        # plt.show()
...
if __name__ == '__main__':
    ...
    # setname='icvl'
    # TrainOrTest = 'Test'
    # save_path = 'D:\ICCV_2017\Mega\data\icvl'
    # h5name = 'icvl_test_norm_hand_uvd_rootmid.h5'
    # matname = 'icvl_test_norm_hand_uvd_rootmid.mat'
    # Metadatadir = 'D:\ICCV_2017\Mega\data\icvl\ICVL_Testing_MetaData.mat'
    # norm_hand(save_path=save_path,
    #           h5name = h5name,
    #           matname = matname,
    #           dataset_dir = 'E:\Dataset\ICVL_dataset_v2_msrc_format\Testing\depth',
    ...
    TrainOrTest = 'Train'
    save_path = 'D:\ICCV_2017\Mega\data\icvl'
    h5name = 'icvl_train_norm_hand_uvd_rootmid.h5'
    matname = 'icvl_train_norm_hand_uvd_rootmid.mat'
    Metadatadir = 'D:\ICCV_2017\Mega\data\icvl\ICVL_Training_MetaData.mat'
    norm_hand(save_path=save_path,
              h5name = h5name,
              matname = matname,
              dataset_dir = 'E:\Dataset\ICVL_dataset_v2_msrc_format\Training\depth',
              Metadatadir = Metadatadir)
