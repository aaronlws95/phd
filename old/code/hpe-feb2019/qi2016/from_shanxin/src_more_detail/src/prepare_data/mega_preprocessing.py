...
def norm_hand(save_path,dataset_dir ):
    print save_path
    u0= 315.944855
    v0= 245.287079
    img_size = 96.0
    ...
    with open('%s%sing_Yang.txt'%(dataset_dir,dataset), 'rb') as f:
        for line in f:
            part = line.split('\t')
...
if __name__ == '__main__':
    #
    dataset = 'Test'
    save_path = '../../data/mega_test_norm_hand_uvd_rootmid_yang.h5'
    # dataset = 'train'
    # save_path = '../../data/mega_train_norm_hand_uvd_rootmid_half.h5'
    setname='mega'
    norm_hand(save_path=save_path,
    dataset_dir = '/home/icvl/shanxin/megahand/',
)
