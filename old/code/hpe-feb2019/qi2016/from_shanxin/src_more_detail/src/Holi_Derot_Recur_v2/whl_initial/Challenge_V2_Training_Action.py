...
if __name__ == '__main__':
    ...
    trainingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Challenge_V2_Training_Action.h5'
    testingdata_name =  '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Challenge_V2_Testing_Action.h5'

    sourcename = '_norm_hand_uvd_rootmid'
    model_info = '_Challenge_V2_Action_'
    # batch_size=256
    batch_size=512
