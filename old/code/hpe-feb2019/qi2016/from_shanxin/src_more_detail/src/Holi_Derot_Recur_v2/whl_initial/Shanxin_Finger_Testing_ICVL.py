...
def train_model_conv3(setname, cross_test_set, num_test_sample,
                      dataset_path_prefix, model_info, source_name, batch_size,
                      num_joints, jnt_idx,c1,c2,c3,h1_out_factor,h2_out_factor,lamda,model_name,model_size,bbsize):
    ...
    pred_y.shape = (pred_y.shape[0],num_joints,3)
    ...
    print 'mean err for 4 joints', numpy.mean(err,axis=0)
...
if __name__ == '__main__':
    ...
    for i in range(0, 5):
        ...
        model_info='uvd_%s_r012_4_jnts' % FingerName
