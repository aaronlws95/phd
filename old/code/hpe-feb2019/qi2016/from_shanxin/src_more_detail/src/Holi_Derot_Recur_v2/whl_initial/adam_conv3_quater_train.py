...
def train_model_conv3(setname, dataset_path_prefix,source_name,batch_size,jnt_idx,c1,c2,c3,h1_out_factor,h2_out_factor,lamda):
    ...
    model_info='uvd_whl_r012_21jnts_quater'
    print model_info
    ...
    train_set_x0, train_set_x1,train_set_x2,train_set_y= load_data_multi_half_train(batch_size=batch_size,path=path,is_shuffle=True,jnt_idx=jnt_idx)
