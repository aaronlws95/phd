...
def train_model_conv3(setname, dataset_path_prefix,source_name,batch_size,jnt_idx,c1,c2,c3,h1_out_factor,h2_out_factor,lamda,
    ...
    if interupt == 0:
        ...
        m,v,beta1_t,beta2_t,_,_ = set_adam_params('%s/.....npy'% (dataset_path_prefix), model.params)
...
if __name__ == '__main__':
    ...
    trainingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Challenge_V2_Training_1_8.h5'
    testingdata_name =  '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Challenge_V2_Testing_1_8.h5'

    sourcename = '_norm_hand_uvd_rootmid'
    model_info = '_Challenge_V2_1_8_Rotation_4_90_'
    # batch_size=256
    batch_size=512
