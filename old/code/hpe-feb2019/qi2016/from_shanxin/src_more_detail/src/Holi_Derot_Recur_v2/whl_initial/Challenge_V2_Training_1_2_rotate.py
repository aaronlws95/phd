...
import numpy
from load_data import  load_data_multi,load_data_multi_rotate_2
...
def train_model_conv3(setname, dataset_path_prefix,source_name,batch_size,jnt_idx,c1,c2,c3,h1_out_factor,h2_out_factor,lamda,
    ...
    train_set_x0, train_set_x1,train_set_x2,train_set_y= load_data_multi_rotate_2(batch_size=batch_size,path=path,is_shuffle=False,jnt_idx=jnt_idx)
    ...
    test_set_x0, test_set_x1,test_set_x2,test_set_y= load_data_multi_rotate_2(batch_size=batch_size,path=path,is_shuffle=False, jnt_idx=jnt_idx)
...
if __name__ == '__main__':
    ...
    trainingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Challenge_V2_Training_1_2.h5'
    testingdata_name =  '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Challenge_V2_Testing_1_2.h5'

    sourcename = '_norm_hand_uvd_rootmid'
    model_info = '_Challenge_V2_1_2_Rotation_2_180_'
    # batch_size=256
    batch_size=256
