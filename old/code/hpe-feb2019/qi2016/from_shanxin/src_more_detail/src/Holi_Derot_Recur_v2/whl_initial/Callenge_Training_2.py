...
def train_model_conv3(setname, dataset_path_prefix,source_name,batch_size,jnt_idx,c1,c2,c3,h1_out_factor,h2_out_factor,lamda,
    ...
    model_info='uvd_challenge2_whl_r012_21jnts'
    # print model_info
...
if __name__ == '__main__':
    ...
    trainingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_trainingloc_Challenge.h5'
