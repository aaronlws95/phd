...
plot(suc_rate*1000, 100*CurveError_Seen(:,f), '-', 'Color', color(5,:), 'LineWidth', 2); hold on;
plot(suc_rate*1000, 100*CurveError_Unseen(:,f), '-', 'Color', color(9,:), 'LineWidth', 2); hold on;
