...
def evalaute_mega_online():
    ...
    for i in range(1,uvd.shape[0],1):
        print(i,file_name[i])
        ...
        xopt, fopt= pso(cost_function_pso, lb, ub, args=args,omega=0.1, phip=0.3, phig=0.8,maxiter=3,swarmsize=100,minfunc=0.1,minstep=0.1,debug=True)
