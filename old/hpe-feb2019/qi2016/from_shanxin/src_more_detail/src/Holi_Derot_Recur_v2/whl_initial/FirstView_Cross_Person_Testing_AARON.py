...
def train_model_conv3(setname, cross_test_set,num_test_sample,
    ...
    model_info='FirstView_CrossPerson'
    print model_info
    ...
    xyz,xyz_gt,err = error.normuvd2xyz_mega(path, pred_y[0:num_test_sample])
...
if __name__ == '__main__':
    ...
    ### for egocentric with objects


    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Guillermo_merged_testing.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Guillermo_merged'
    # num_test_sample = 17429

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Guillermo_merged_testing_half.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Guillermo_merged_half'
    # num_test_sample = 8715

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Shanxin_merged_testing.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Shanxin_merged'
    # num_test_sample = 22379

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Shanxin_merged_testing_half.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Shanxin_merged_half'
    # num_test_sample = 11190

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Pamela_merged_testing.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Pamela_merged'
    # num_test_sample = 17191

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Pamela_merged_testing_half.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Pamela_merged_half'
    # num_test_sample = 8590

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Juil_merged_testing.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Juil_merged'
    # num_test_sample = 14558

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Qi_merged_testing.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Qi_merged'
    # num_test_sample = 17756

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Seungryul_merged_testing.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_V2_Action_Seungryul_merged'
    # num_test_sample = 15767

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Frame_Annotation_baseline.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_norm_hand_uvd_rootmid_Frame_Annotation_baseline'
    # num_test_sample = 295510

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Tracking_Annotation_baseline.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_norm_Tracking_1_2_rotate_2_result'
    # num_test_sample = 292820

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Frame_Annotation_baseline.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_norm_Frame_1_2_rotate_2_result'
    # num_test_sample = 295510

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Frame_Annotation_baseline.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_norm_Frame_1_4_rotate_4_result'
    # num_test_sample = 295510

    # testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Tracking_Annotation_baseline.h5'
    # setname = 'challenge'
    # cross_test_set = 'Challenge_norm_Tracking_1_4_rotate_4_result'
    # num_test_sample = 292820

    testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/FristView_Cross_testing_crossperson.h5'
    setname = 'challenge'
    cross_test_set = 'FirstView_CrossPerson'
    num_test_sample = 54693
    ...
    train_model_conv3(
        ...
        model_name='FirstView_Cross_64_96_128_1_2_adam_lm99',
        # model_name='_Challenge_V2_1_2_Rotation_2_180__64_96_128_1_2_adam_lm99_199',
        # model_name='_Challenge_V2_1_4_Rotation_4_90__64_96_128_1_2_adam_lm99_echo_124',
        model_size='full',
        bbsize=bbsize,
        source_name='FirstView_CrossPerson',
        lamda=0.0001,
        batch_size=64,
