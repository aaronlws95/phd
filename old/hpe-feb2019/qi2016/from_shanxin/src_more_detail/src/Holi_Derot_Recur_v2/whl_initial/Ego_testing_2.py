...
if __name__ == '__main__':
    ...
    bbsize=260
    print 'bbsize=',bbsize
    testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/ego/Ego_norm_hand_uvd_rootmid_testingloc_All_EGO_CNN_sara.h5'

    sourcename = '_norm_hand_uvd_rootmid'
    model_info = 'uvd_50_50_whl_r012_21jnts_EGO_2_'

    train_model_conv3(model_info=model_info,
                    setname='ego',
                    cross_test_set = 'ego',
                    num_test_sample = 26773,
                    dataset_path_prefix=constants.Data_Path,
                    model_name='uvd_50_50_whl_r012_21jnts_EGO_2__64_96_128_1_2_adam_lm99',
                    model_size='full',
                    bbsize=bbsize,
