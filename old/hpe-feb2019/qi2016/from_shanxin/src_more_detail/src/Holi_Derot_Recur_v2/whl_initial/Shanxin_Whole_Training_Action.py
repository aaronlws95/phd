...
def train_model_conv3(setname, dataset_path_prefix,source_name,batch_size,jnt_idx,c1,c2,c3,h1_out_factor,h2_out_factor,lamda,
    ...
    if interupt == 0:
        ...
        m,v,beta1_t,beta2_t,_,_ = set_adam_params('%s/expcost_uvd_whl_r012_21jnts_64_96_128_1_2_adam_lm99_bf.npy'% (dataset_path_prefix), model.params)
...
if __name__ == '__main__':
    ...
    setname = 'action'
    dataset_path_prefix = '/media/Data/shanxin/StructuralHand/Mega/data/action/'
    trainingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/action/mega_Train_norm_hand_uvd_rootmid_AA_trainingloc_All_EGO_Tenfolds_9.h5'
    testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/action/mega_50_50_Test_norm_hand_uvd_rootmid_testing_50_50_Mar_08_2017.h5'
