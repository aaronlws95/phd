...
def norm_hand(save_path,dataset_dir,jointlocations):
    ...
    for i in xrange(0,xyz_jnt_gt.shape[0],1):
        ...
        depth = Image.open('%s/images/%s' % (dataset_dir,file_name[i]))
...
if __name__ == '__main__':
    ...
    jointlocations = 'Hand_Object_baseline'
    save_path = '../../data/challenge/Challenge_norm_hand_uvd_rootmid_%s.h5' % jointlocations

    norm_hand(save_path=save_path,
    dataset_dir = '/media/Data/shanxin/hand_object/Final/', jointlocations = jointlocations)
