...
class CNN_Model_multi3_conv3(object):
    ...
    def save_adam(self,path,c00,c01,c02,h1_out_factor,h2_out_factor,lamda,epoch,train_cost,test_cost):
        params_value = []
        for param_i in self.params:
            params_value.append(param_i.get_value())
        np.save("%sparam_cost_%s_%d_%d_%d_%d_%d_adam_lm%d"%(path,self.model_info,c00,c01,c02,h1_out_factor,h2_out_factor,lamda),[params_value,self.hyper_params,train_cost,test_cost])
...
class CNN_Model_multi3(object):
    ...
    def save_adam(self,path,c00,c01,h1_out_factor,h2_out_factor,lamda,epoch,train_cost,test_cost):
        params_value = []
        for param_i in self.params:
            params_value.append(param_i.get_value())
        np.save("%sparam_cost_%s_%d_%d_%d_%d_adam_lm%d"%(path,self.model_info,c00,c01,h1_out_factor,h2_out_factor,lamda),[params_value,self.hyper_params,train_cost,test_cost])
