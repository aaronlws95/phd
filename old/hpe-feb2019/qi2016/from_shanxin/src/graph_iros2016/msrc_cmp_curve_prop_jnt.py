...
tmp = numpy.sqrt(numpy.sum((holi_derot_recur_xyz- xyz_true)**2,axis=-1))*1000
...
c2, = plt.plot(thresholds, accuracy_hsf,linewidth=1,c=color[2], hold=True)
...
plt.grid('on')
# plt.show()
plt.savefig('C:/Proj/Proj_Hier_Hand_eccv2016_07042016/Proj_CNN_Hier/data/HDJIF_cmp_prior/iros2016_fig/msrccmppropjnt.eps',format='eps', dpi=300)
