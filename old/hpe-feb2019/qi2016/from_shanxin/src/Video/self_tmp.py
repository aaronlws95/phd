...
if __name__ =='__main__':
    ...
    for image_index in xrange(100,300,1):
        ...
        ax0.set_yticklabels([])
        ax0.set_axis_off()
        gs = gridspec.GridSpec(2,3,left=0.35, right=0.95,bottom=0.1,top=0.7,wspace=0.0, hspace=0)
        ...
        plt.text(h0_off+step,v0_off,'Holi',ha='center', va='center',size=20,color='k')
        plt.text(h0_off+step*2,v0_off,'Holi_Derot',ha='center', va='center',size=20,color='k')
        plt.text(h0_off+step*3,v0_off,'Holi_SA',ha='center', va='center',size=20,color='k')
        
        plt.text(h0_off+step*1,v0_off,'Hier_SA',ha='center', va='center',size=20,color='k')
        plt.text(h0_off+step*2,v0_off,'Hybrid_Hier_SA',ha='center', va='center',size=20,color='k')
        ...
        # plt.savefig('C:/Proj/Proj_CNN_Hier/data/HDJIF_cmp_prior/%s_ECCV2016_EXAMP/%s%04d.png'%(setname,setname,image_index+1),format='png',dpi=300)
        # plt.close('all')
