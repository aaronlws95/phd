...
def test_model(dataset,setname, dataset_path_prefix,source_name,batch_size,jnt_idx,patch_size,offset_depth_range,c1,c2,h1_out_factor,h2_out_factor,model_save_path,offset_save_path):
    ...
    test_set_x0, test_set_x1,test_set_x2,test_set_y= load_data_multi_mid_uvd_normalized(batch_size,path,jnt_idx=jnt_idx,is_shuffle=False,
