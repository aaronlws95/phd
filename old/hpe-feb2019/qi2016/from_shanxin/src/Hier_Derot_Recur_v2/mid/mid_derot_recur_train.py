...
def train_model(setname, dataset_path_prefix,source_name,batch_size,jnt_idx,patch_size,offset_depth_range,c1,c2,h1_out_factor,h2_out_factor,lamda):
    beta1 = 0.6
    beta2 =0.6
    print 'offset_depth_range ',offset_depth_range
    model_info='offset_mid%d_patch%d_beta%d'%(jnt_idx[0],patch_size,beta1*10)
    ...
    train_set_x0, train_set_x1,train_set_x2,train_set_y= load_data_multi_mid_uvd_normalized(batch_size,path,jnt_idx=jnt_idx,is_shuffle=True,
    ...
    test_set_x0, test_set_x1,test_set_x2,test_set_y= load_data_multi_mid_uvd_normalized(batch_size,path,jnt_idx=jnt_idx,is_shuffle=True,
                                                                                        patch_size=patch_size,patch_pad_width=4,hand_width=96,hand_pad_width=0,offset_depth_range=offset_depth_range)
    ...
    train_cost=[0]
    done_looping=False
    save_path = '%sdata/%s/hier_derot_recur_v2/mid/'%(dataset_path_prefix,setname)
