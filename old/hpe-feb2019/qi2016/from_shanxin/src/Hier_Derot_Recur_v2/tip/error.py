...
def tip_derot_err_uvd_xyz(dataset,prev_jnt_name,setname,dataset_path_prefix,source_name,source_name_ori,pred_save_name,jnt_idx,patch_size=24,offset_depth_range=0.8):
    ...
    direct =  '%sdata/%s/hier_derot_recur_v2/tip/best/'%(dataset_path_prefix,setname)
...
if __name__=='__main__':
    ...
    for i , idx in enumerate(idx_all):
        err= tip_derot_err_uvd_xyz(dataset='test',
                                   setname='icvl',
                                 ...
                                 prev_jnt_name='_absuvd0_offset_top%d_patch40_beta6_24_48_1_1_adam_lm3'%(idx-1),
                                     pred_save_name='_offset_tip%d_patch40_beta6_24_48_1_1_adam_lm3'%idx,
                                     patch_size=40,
    ...
    #                          source_name_ori='_icvl_r0_r1_r2_uvd_bbox_21jnts_20151113_depth200',
    #                          prev_jnt_name='_absuvd0_offset_top%d_patch40_beta6_24_48_1_1_adam_lm3'%(idx-1),
    #                              pred_save_name='_offset_tip%d_patch40_beta6_14_28_1_1_adam_lm3'%idx,
    #                              patch_size=40,
    #                              offset_depth_range=0.4,
    #                              jnt_idx = [idx])