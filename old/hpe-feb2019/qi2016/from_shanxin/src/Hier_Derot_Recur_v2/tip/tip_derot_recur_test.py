...
def train_model(dataset,setname, dataset_path_prefix,source_name,prev_jnt_name,batch_size,jnt_idx,patch_size,offset_depth_range,c1,c2,h1_out_factor,h2_out_factor,model_save_path,offset_save_path):
    ...
    model_info='offset_tip%d_r012_21jnts_derot_patch%d'%(jnt_idx[0],patch_size)
    ...
    test_set_x0, test_set_x1,test_set_x2,test_set_y= load_data_multi_tip_uvd_normalized(batch_size,path,prev_jnt_path,jnt_idx=jnt_idx,is_shuffle=False,
...
if __name__ == '__main__':
    ...
    for i ,idx in enumerate(idx_all):
        train_model(setname='icvl',
                    ...
                    prev_jnt_name= '_absuvd0_offset_top%d_patch40_beta6_24_48_1_1_adam_lm3'%(idx-1),
                    batch_size = 133,
                    jnt_idx = [idx],
                    patch_size=40,
                    ...
                    h1_out_factor=1,
                    h2_out_factor=1,
                    model_save_path = '_offset_tip%d_patch40_beta6_24_48_1_1_adam_lm3'%idx,
                    offset_save_path ='_offset_tip%d_patch40_beta6_24_48_1_1_adam_lm3'%idx )
    # idx=11
    # train_model(setname='icvl',
    #             dataset='test',
    #             dataset_path_prefix=constants.Data_Path,
    ...
    #             h1_out_factor=1,
    #             h2_out_factor=1,
    #             model_save_path = '_offset_tip%d_patch40_beta6_14_28_1_1_adam_lm3'%idx,
    #             offset_save_path ='_offset_tip%d_patch40_beta6_14_28_1_1_adam_lm3'%idx )
