...
def train_model(num_iter,setname, dataset_path_prefix,source_name,batch_size,jnt_idx,patch_size,c1,c2,h1_out_factor,h2_out_factor,lamda):
    if num_iter == 1:
    ...
    # model_save_path = "%sparam_cost_egoff_adam_iter1_bw1_r012_24_48_1_1_adam_lm0.npy"%(save_path)
