...
def get_dataset(cfg, split):
    ...
    elif dataset == 'fpha_multireso_hand_crop':
        from src.datasets.fpha_multireso_hand_crop_dataset import FPHA_Multireso_Hand_Crop_Dataset
        return FPHA_Multireso_Hand_Crop_Dataset(cfg, split)
    elif dataset == 'fpha_multireso_hand_crop_normuvd':
        from src.datasets.fpha_multireso_hand_crop_normuvd_dataset import FPHA_Multireso_Hand_Crop_Normuvd_Dataset
        return FPHA_Multireso_Hand_Crop_Normuvd_Dataset(cfg, split)
    elif dataset == 'fpha_hand_crop':
        from src.datasets.fpha_hand_crop_dataset import FPHA_Hand_Crop_Dataset
        return FPHA_Hand_Crop_Dataset(cfg, split)
    elif dataset == 'fpha_hand_heatmap':
        from src.datasets.fpha_hand_heatmap_dataset import FPHA_Hand_Heatmap_Dataset
        return FPHA_Hand_Heatmap_Dataset(cfg, split)
    else:
