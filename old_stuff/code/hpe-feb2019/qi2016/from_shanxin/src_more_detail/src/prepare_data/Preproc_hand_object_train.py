...
if __name__ == '__main__':
    ...
    # jointlocations = 'Annotation_testing'
    jointlocations = 'Annotation_train'
    save_path = '../../data/challenge/Hand_object_%s.h5' % jointlocations

    norm_hand(save_path=save_path,
    dataset_dir = '/media/Data/shanxin/Hand_object/', jointlocations = jointlocations)
