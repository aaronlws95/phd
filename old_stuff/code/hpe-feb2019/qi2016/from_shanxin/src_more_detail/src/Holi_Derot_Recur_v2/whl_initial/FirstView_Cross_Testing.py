...
if __name__ == '__main__':
    ...
    testingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/FristView_Cross_testing_crossobject.h5'
    setname = 'challenge'
    cross_test_set = 'FirstView_Cross'
    num_test_sample = 50791
