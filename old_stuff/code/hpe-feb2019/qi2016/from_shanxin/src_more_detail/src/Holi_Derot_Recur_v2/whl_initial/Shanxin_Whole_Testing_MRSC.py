...
def train_model_conv3(setname, cross_test_set,num_test_sample,
    ...
    model_info='uvd_Whole_r012_6_jnts'
    print model_info
    ...
    xyz,xyz_gt,err = error.normuvd2xyz(cross_test_set,path,pred_y[0:num_test_sample])
...
if __name__ == '__main__':
    ...
    train_model_conv3(
                    ...
                    model_name='uvd_Whole_r012_6_jnts_64_96_128_1_2_adam_lm99_bf',
                    model_size='full',
                    bbsize=bbsize,
