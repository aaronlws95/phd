...
if __name__ == '__main__':
    ...
    setname = 'action'
    dataset_path_prefix = '/media/aaron/DATADRIVE1/data/shanxin'
    trainingdata_name = '/media/aaron/DATADRIVE1/data/train_fpha_cross_subject_shanxin.h5'
    testingdata_name =  '/media/aaron/DATADRIVE1/data/test_fpha_cross_subject_shanxin.h5'
