...
if __name__ == '__main__':
    ...
    trainingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/ego/Ego_norm_hand_uvd_rootmid_trainingloc_All_EGO_CNN_Qi.h5'
    ...
    model_info = 'uvd_50_50_whl_r012_21jnts_EGO_9_'
    # batch_size=256
    batch_size=512
