...
import numpy
from load_data import  load_data_multi, load_data_multi_rotate_4
...
def train_model_conv3(setname, dataset_path_prefix,source_name,batch_size,jnt_idx,c1,c2,c3,h1_out_factor,h2_out_factor,lamda,
                      trainingdata_name, testingdata_name, model_info):
    ...
    train_set_x0, train_set_x1,train_set_x2,train_set_y= load_data_multi_rotate_4(batch_size=batch_size,path=path,is_shuffle=True,jnt_idx=jnt_idx)
    ...
    test_set_x0, test_set_x1,test_set_x2,test_set_y= load_data_multi_rotate_4(batch_size=batch_size,path=path,is_shuffle=True, jnt_idx=jnt_idx)
    ...
    if interupt == 0:
        ...
        m,v,beta1_t,beta2_t,_,_ = set_adam_params('%sparam_cost__Challenge_V2_1_4_Rotation_4_90__64_96_128_1_2_adam_lm99_bf.npy'% (dataset_path_prefix), model.params)
...
if __name__ == '__main__':
    ...
    setname = 'action'
    dataset_path_prefix = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/'
    trainingdata_name = '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Challenge_V2_Training_1_4.h5'
    testingdata_name =  '/media/Data/shanxin/StructuralHand/Mega/data/challenge/Challenge_norm_hand_uvd_rootmid_Challenge_V2_Testing_1_4.h5'

    sourcename = '_norm_hand_uvd_rootmid'
    model_info = '_Challenge_V2_1_4_Rotation_4_90_'
    # batch_size=256
    batch_size=512
