...
def err_uvd_xyz(dataset,dataset_path_prefix,souce_name_ori,setname,pred_save_name):
    ...
    pred_path = '%sdata/%s/hier_derot_recur_v2/bw_initial/best/'%(dataset_path_prefix,setname)
...
if __name__=='__main__':
    ...
    #             souce_name_ori='_nyu_r0_r1_r2_uvd_bbox_21jnts_20151113_depth300',
    #             pred_save_name = '_uvd_bw_r012_21jnts_96_192_384_4_8_gm0_lm2000_yt0_ep70')
    ...
    err_uvd_xyz(dataset='test',setname='icvl',
    dataset_path_prefix=constants.Data_Path,
                souce_name_ori='_icvl_r0_r1_r2_uvd_bbox_21jnts_20151113_depth200',
                pred_save_name = '_uvd_bw_r012_21jnts_64_96_128_1_1_adam_lm9_ep33')