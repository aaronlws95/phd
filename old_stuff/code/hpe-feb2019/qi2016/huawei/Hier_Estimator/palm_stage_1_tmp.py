...
def load_data(save_dir,dataset):
    ...
    train_x0 = f['img0'][...][:10000]
    train_y= f['uvd_norm_gt'][...][:,palm_idx,:][:10000]
    f.close()

    normuvd = numpy.load("%s/hier/result/%s_normuvd_palm_s0_rot_scale_ker32_lr0.000100.npy"%(save_dir,dataset))[:10000]
...
def train():
    ...
    test_x0,test_y,test_pred_palm = load_data(save_dir,dataset='train')
